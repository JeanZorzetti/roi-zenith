  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center mt-16">
        ...
        <Button 
          size="lg" 
          className="bg-pure-white text-pure-black hover:bg-pure-white/90 font-light tracking-wide px-8 py-3 rounded-full border border-white/30 transition-all duration-300 hover:-translate-y-1" 
